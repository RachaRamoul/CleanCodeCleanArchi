...
export class CreateCompany1737215239341 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "motorcycles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "motorcycleId" character varying NOT NULL, "modelId" character varying NOT NULL, "mileage" integer NOT NULL, "status" character varying NOT NULL, "companyId" character varying NOT NULL, CONSTRAINT "PK_6e34aca06f3000916257494a4aa" PRIMARY KEY ("id"))`);
